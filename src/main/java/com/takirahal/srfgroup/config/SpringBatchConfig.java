...
public class SpringBatchConfig {
    ...
    @Bean
    public Job bankJob(){
        Step step0 = stepBuilderFactory.get("step-load-data")
    ...
    @Bean
    public FlatFileItemReader<Address> flatFileItemReader(@Value("${inputFile}") Resource inputFile){
    ...
    @Bean
    public LineMapper<Address> lineMapper() {
    ...
    @Bean
    public ItemProcessor<Address, Address> itemProcessor(){
